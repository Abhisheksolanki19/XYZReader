...
public class DetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            titleView.setText(mCursor.getString(ArticleLoadClass.Query.TITLE));
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoadClass.Query.BODY).substring(0, 1000).replaceAll("(\r\n|\n)", "<br />")));
            ImageLoaderHelper.getInstance(getActivity()).getImageLoader()
                    .get(mCursor.getString(ArticleLoadClass.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        @Override
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return ArticleLoadClass.newInstanceForItemId(getActivity(), mItemId);
    }
