...
public class SelectClass {
     ...
     */
    public SelectClass where(String selection, String... selectionArgs) {
    ...
    public SelectClass table(String table) {
        mTable = table;
        return this;
    }
    ...
    public SelectClass mapToTable(String column, String table) {
        ensureProjectionMap();
        mProjectionMap.put(column, table + "." + column);
        return this;
    }

    public SelectClass map(String fromColumn, String toClause) {
        ensureProjectionMap();
